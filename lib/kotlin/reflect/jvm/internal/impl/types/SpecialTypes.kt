...
class DefinitelyNotNullType private constructor(
    ...
    companion object {
        ...
        private fun makesSenseToBeDefinitelyNotNull(
            ...
            // (see the tests kotlin.reflect.jvm.internal.impl.spec.checkers.DiagnosticsTestSpecGenerated.NotLinked.Dfa.Pos.test12/13)
            // So it should be a language feature, but it's hard correctly identify language version settings for all call sites
            // Thus, we have non-trivial value at kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.JavaTypeEnhancement.notNullTypeParameter
